...
public class SystemMenuController {
    ...
    public ResponseEntity<String> systemFunctionMenu() throws Exception{
        return systemMenuService.systemFunctionMenu(IwsContext.getData());
    }
    ...
    public ResponseEntity<String> getSystemFunctionMenu() throws Exception{
        return systemMenuService.getSystemFunctionMenu(IwsContext.getData(),IwsContext.getPageInfo());
    }
