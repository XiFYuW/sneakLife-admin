...
public class RedisCacheInterceptor {
	 ...
	 */
	@SuppressWarnings("unchecked")
	@Around("@annotation(com.sneaklife.util.redis.Interceptor.InsertCache) && @annotation(insertCache)")
	 ...
	 */
	@SuppressWarnings("unchecked")
	@Around("@annotation(com.sneaklife.util.redis.Interceptor.UpdateCache) && @annotation(updateCache)")
