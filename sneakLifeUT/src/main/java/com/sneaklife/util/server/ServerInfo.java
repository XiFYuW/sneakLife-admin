package com.sneaklife.util.server;
...
public class ServerInfo {
	...
	private List<CpuInfo> cpuList;//cpu信息
	...
	public String toString() {
		return "{\"serverIP\":\"" + serverIP + "\", \"serverURL\":\"" + serverURL + "\", \"serverType\":\"" + serverType
				+ "\", \"serverTime\":\"" + serverTime + "\", \"osName\":\"" + osName + "\", \"osVersion\":\""
				+ osVersion + "\", \"userName\":\"" + userName + "\", \"userHome\":\"" + userHome
				+ "\", \"osTimeZone\":\"" + osTimeZone + "\", \"memTotal\":\"" + memTotal + "\", \"memUsed\":\""
				+ memUsed + "\", \"memFree\":\"" + memFree + "\", \"cpuNum\":\"" + cpuNum + "\", \"cpuList\":\""
				+ cpuList + "\", \"netNum\":\"" + netNum + "\", \"netList\":\"" + netList + "\", \"javaPath\":\""
				+ javaPath + "\", \"javaVendor\":\"" + javaVendor + "\", \"javaVersion\":\"" + javaVersion
				+ "\", \"javaName\":\"" + javaName + "\", \"jvmVersion\":\"" + jvmVersion + "\", \"jvmTotalMemory\":\""
				+ jvmTotalMemory + "\", \"jvmFreeMemory\":\"" + jvmFreeMemory + "\", \"databaseType\":\"" + databaseType
				+ "\", \"databaseVersion\":\"" + databaseVersion + "\", \"databaseDriver\":\"" + databaseDriver
				+ "\", \"driverVersion\":\"" + driverVersion + "\", \"jdbcUrl\":\"" + jdbcUrl + "\"}";
	}
}
