...
import com.sneaklife.dao.system.business.businessFunction.FunctionButtonJpa;
import com.sneaklife.dao.system.business.businessFunction.FunctionButtonMapper;
...
public class FunctionButtonServiceImp extends CommonJpaService implements FunctionButtonService {
    ...
    public ResponseEntity<String> getFunctionButton(Map<String, Object> map, PageInfo pageInfo) throws Exception{
        Page<OperaSb> page = getPageData(map, pageInfo, functionButtonJpa);
